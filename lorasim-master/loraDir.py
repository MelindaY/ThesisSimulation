...
class myNode():
    def __init__(self, nodeid, bs, period,packetlen):
        ...
        self.packet.reset_sf_fromGW(self.sf)
                ...
                if remove_number > 2:
                    for k in range(0, remove_number):
                        if j+1<6:
                            ...
                            tmp_node.sf = tmp_node.packet.sf+1
...
if __name__ == "__main__":
    ...
    fname = "exp" + str("nodesNum") + ".dat"
    print(fname)
    if os.path.isfile(fname):
        res = "\n" + str(nrNodes) + " " + str(nrCollisions) + " " + str(sent) + " " + str(energy)+ " " + str(experiment)
    else:
        res = "#nrNodes nrCollisions nrTransmissions OverallEnergy  ExperimentNumer\n" + str(nrNodes) + " " + str(
            nrCollisions) + " " + str(sent) + " " + str(energy)+ " " + str(experiment)
